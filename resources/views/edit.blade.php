...
<body>
    <div class="wrapper bg-white">
        ...
        <div class="h4 text-muted text-center pt-2">Update A Product</div>
        ...
        <form method="POST" enctype="multipart/form-data" class="pt-3">
            ...
            <div class="form-group py-2 pb-2">
                ...
                <div class="input-field">
                    <textarea name="description" id="description" class="form-control" rows="3" placeholder="Product Description">
                            {{ $product->description }}
                    </textarea>
                </div>
            </div>
            ...
            <div class="form-group py-2 pb-2">
                ...
                <div class="input-field">
                    <select class="w-100 border-0" id="select" name="status">
                        <option @if ($product->status == 0) selected @endif>0</option>
                        <option @if ($product->status == 1) selected @endif>1</option>
                    </select>
                </div>
            </div>

            <button class="btn btn-block text-center my-3 d-flex justify-content-center text-center" type="submit">
                Update Product
            </button>
        </form>
    </div>
